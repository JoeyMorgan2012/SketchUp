...
namespace SketchUp
{
    public class SketchUpParcelDataCollection : List<SketchUpParcelData>
    {
        ...
        public DataTable GetData(List<SearchParameter> parms, bool loadCollection)
        {
            ...
            sqlcount.Append(String.Format(" from {0}.{1}mast ", SketchUpGlobals.LocalLib, SketchUpGlobals.LocalityPreFix));
        ...
        public void getParcel(SWallTech.CAMRA_Connection db, int record, int card)
        {
            ...
            subParcel.Append(String.Format(" from {0}.{1}mast where mrecno = {2} and mdwell = {3} and moccup < 30 ", SketchUpGlobals.LocalLib, SketchUpGlobals.LocalityPreFix, Record, Card));
