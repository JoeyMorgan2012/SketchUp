...
namespace SketchUp
{
    public class LandDataCollection : List<LandData>
    {
        ...
        public DataTable GetLand(SWallTech.CAMRA_Connection fox, int record, int card)
        {
            ...
            lsql.Append(String.Format("from {0}.{1}land where lrecno = {2} and ldwell = {3} order by lseqno", SketchUpGlobals.LocalLib, SketchUpGlobals.LocalityPreFix, record, card));
        ...
        public void GetLand(int _record, int _card)
        {
            ...
            subLand.Append(String.Format(" from {0}.{1}land where lrecno = {2} and ldwell = {3} ", SketchUpGlobals.LocalLib, SketchUpGlobals.LocalityPreFix, _record, _card));
            ...
            sum_land.Append(String.Format("select sum(ltotal) from {0}.{1}land where lrecno = {2} and ldwell = {3} and laccod > 0 ", SketchUpGlobals.LocalLib, SketchUpGlobals.LocalityPreFix, _record, _card));
